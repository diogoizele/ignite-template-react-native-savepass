...
export function RegisterLoginData() {
  ...
  async function handleRegister(formData: FormData) {
    ...
    const rawPreviousData = await AsyncStorage.getItem(dataKey);
    const previousData = rawPreviousData ? JSON.parse(rawPreviousData) : [];

    const dataFormatted = [...previousData, newLoginData];
